...
class MainActivity : AppCompatActivity(), HorizontalImageAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        horizontalAdapter = HorizontalImageAdapter(items, this)
        ...
        findViewById<Button>(R.id.previousButton).setOnClickListener {
            ...
            if (currentItem > 0) {
                ...
                horizontalRecyclerView.smoothScrollToPosition(currentItem - 1)
            }
        }
    ...
    override fun onItemClick(position: Int) {
        ...
        layoutManager.scrollToPositionWithOffset(position, 50)  // Adjust the 50 value as per your requirement to scroll a little bit
    }
}
